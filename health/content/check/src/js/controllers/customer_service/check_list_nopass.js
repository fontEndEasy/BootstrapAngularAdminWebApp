...
app.controller('CheckListNopass', function ($rootScope, $scope, $state, $timeout, $http, $compile, utils) {
            ...
            dTable = doctorList.dataTable({
                ...
                "fnServerData": function (sSource, aoData, fnCallback) {
                    $http({
                        ...
                        utils.extendHash(_dt.pageData, ["doctorNum", "title", "hospital", "name", "telephone", "remark", "licenseExpire", "licenseNum", "userId", "createTime", "departments"]);
                        ...
                        // 更新界面中的数据
                        $('#check_nopass').html(resp.recordsTotal);
