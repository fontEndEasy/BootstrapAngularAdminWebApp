'use strict';
//病情跟踪题库
app.controller('QuestionsOfDiseaseCtrl', function($rootScope, $scope, $state, $http, $compile, utils, $modal, toaster) {
...
//详情弹窗
app.controller('viewPopCtrl2', function($rootScope, $scope, $modalInstance, $http, utils, viewData) {
