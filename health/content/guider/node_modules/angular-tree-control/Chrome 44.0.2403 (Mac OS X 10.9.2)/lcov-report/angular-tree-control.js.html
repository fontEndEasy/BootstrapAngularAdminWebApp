...
<html lang="en">
<head>
    <title>Code coverage report for ./angular-tree-control.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">./angular-tree-control.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.62% <small>(200 / 207)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">90.3% <small>(121 / 134)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(34 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">96.62% <small>(200 / 207)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">./</a> &#187; angular-tree-control.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">4092</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3702</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* commonjs package manager support (eg componentjs) */
<span class="missing-if-branch" title="if path not taken"" >I</span>if (typeof module !== "undefined" &amp;&amp; typeof exports !== "undefined" &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >module.exports === exports)</span>{
<span class="cstat-no" title="statement not covered" >  module.exports = 'treeControl';</span>
}
(function ( angular ) {
    'use strict';
...
&nbsp;
                    function shallowCopy(src, dst) {
                        <span class="missing-if-branch" title="if path not taken"" >I</span>if (angular.isArray(src)) {
<span class="cstat-no" title="statement not covered" >                            dst = dst || [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                            for ( var i = 0; i &lt; src.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                                dst[i] = src[i];</span>
                            }
                        } else <span class="missing-if-branch" title="else path not taken"" >E</span>if (angular.isObject(src)) {
                            dst = dst || {};
&nbsp;
                            for (var key in src) {
...
&nbsp;
                        return dst || <span class="branch-1 cbranch-no" title="branch not covered" >src;</span>
                    }
...
&nbsp;
                    $scope.selectNodeHead = function() {
                        ...
                        <span class="missing-if-branch" title="else path not taken"" >E</span>if ($scope.onNodeToggle) {
...
&nbsp;
                    $scope.selectNodeLabel = function( selectedNode){
                        ...
                        if(!$scope.options.isLeaf(selectedNode) &amp;&amp; (!$scope.options.dirSelectable || !$scope.options.isSelectable(selectedNode))) {
                            ...
                            <span class="missing-if-branch" title="else path not taken"" >E</span>if ($scope.onSelection) {
                                var parentNode = (transcludedScope.$parent.node === transcludedScope.synteticRoot)?null:transcludedScope.$parent.node;
...
&nbsp;
                        scope.$watch("treeModel", function updateNodeOnRootScope(newValue) {
                            <span class="missing-if-branch" title="else path not taken"" >E</span>if (angular.isArray(newValue)) {
...
<span class="cstat-no" title="statement not covered" >                                if (angular.equals(scope.node, newValue))</span>
<span class="cstat-no" title="statement not covered" >                                    return;</span>
<span class="cstat-no" title="statement not covered" >                                scope.node = newValue;</span>
                            }
                        });
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Aug 10 2015 17:24:00 GMT+0300 (IDT)</div>
</div>
