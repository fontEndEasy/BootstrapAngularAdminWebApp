  ...
  ['$stateProvider', '$urlRouterProvider', 'JQ_CONFIG',
    function($stateProvider, $urlRouterProvider, JQ_CONFIG) {
      ...
      $stateProvider.state('app', {
        ...
        url: '/nav',
        templateUrl: 'tpl/nav_list.html',
        resolve: {
          deps: ['$ocLazyLoad',
            function($ocLazyLoad) {
              return $ocLazyLoad.load(['js/controllers/nav/nav.js']);
            }
          ]
        }
      }).state('app.org', {
        url: '/org',
        templateUrl: 'tpl/org/org.html',
        resolve: {
          deps: ['$ocLazyLoad', 'uiLoad',
            function($ocLazyLoad, uiLoad) {
              return $ocLazyLoad.load('angularBootstrapNavTree').then(function() {
                return $ocLazyLoad.load('js/controllers/org/org.js');
              }).then(function() {
        ...
        url: '/position',
        templateUrl: 'tpl/org/position/position.html',
        resolve: {
          deps: ['$ocLazyLoad', 'uiLoad',
            function($ocLazyLoad, uiLoad) {
              return $ocLazyLoad.load('angularBootstrapNavTree').then(function() {
                return $ocLazyLoad.load('js/controllers/org/position/position.js');
              }).then(function() {
                return uiLoad.load(JQ_CONFIG.dataTable).then(function() {
                  //return $ocLazyLoad.load('js/controllers/org/org.js');
                });
        ...
        url: '/employee',
        templateUrl: 'tpl/org/employee/employee.html',
        resolve: {
          deps: ['$ocLazyLoad', 'uiLoad',
            function($ocLazyLoad, uiLoad) {
              return $ocLazyLoad.load('angularBootstrapNavTree').then(function() {
                return $ocLazyLoad.load('js/controllers/org/employee/employee.js');
              }).then(function() {
                return uiLoad.load(JQ_CONFIG.dataTable).then(function() {
                });
              });
        ...
        url: '/add',
        templateUrl: 'tpl/org_add.html',
        resolve: {
          deps: ['$ocLazyLoad','uiLoad',
            function($ocLazyLoad, uiLoad) {
              return uiLoad.load(JQ_CONFIG.chosen).then(function() {
                return $ocLazyLoad.load('js/controllers/org/org_add.js');
              });
            }
          ]
        }
        ...
        url: '/details',
        templateUrl: 'tpl/org/details.html',
        resolve: {
          deps: ['$ocLazyLoad','uiLoad',
            function($ocLazyLoad, uiLoad) {
              return uiLoad.load(JQ_CONFIG.chosen).then(function() {
                return $ocLazyLoad.load('js/controllers/org/orgDetails.js');
              });
            }
          ]
        }
        ...
        resolve: {
          deps: ['uiLoad',
            function(uiLoad) {
              return uiLoad.load(['js/app/map/load-google-maps.js', 'js/app/map/ui-map.js', 'js/app/map/map.js']).then(function() {
      ...
      .state('app.calendar', {
        ...
        resolve: {
          deps: ['$ocLazyLoad', 'uiLoad',
            function($ocLazyLoad, uiLoad) {
              return uiLoad.load(JQ_CONFIG.fullcalendar.concat('js/app/calendar/calendar.js')).then(function() {
      ...
      .state('app.mail', {
        ...
        resolve: {
          deps: ['uiLoad',
            function(uiLoad) {
              return uiLoad.load(['js/app/mail/mail.js', 'js/app/mail/mail-service.js',
                JQ_CONFIG.moment
              ]);
            }
          ]
          ...
          deps: ['$ocLazyLoad',
            function($ocLazyLoad) {
              return $ocLazyLoad.load({
                ...
                files: ['js/app/weather/skycons.js', 'js/app/weather/angular-skycons.js', 'js/app/weather/ctrl.js',
                  JQ_CONFIG.moment
                ]
              });
            }
        ...
        resolve: {
          deps: ['$ocLazyLoad',
            function($ocLazyLoad) {
              return $ocLazyLoad.load(['com.2fdevs.videogular', 'com.2fdevs.videogular.plugins.controls', 'com.2fdevs.videogular.plugins.overlayplay', 'com.2fdevs.videogular.plugins.poster', 'com.2fdevs.videogular.plugins.buffering', 'js/app/music/ctrl.js', 'js/app/music/theme.css']);
            }
          ]
        }
      }).state('music.home', {
