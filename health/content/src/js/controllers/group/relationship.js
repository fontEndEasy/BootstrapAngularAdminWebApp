        ...
        var setTable = function () {
            ...
            dTable = doctorList.dataTable({
                ...
                "columns": [{
                    ...
                    "render": function (set, status, dt) {
                        var a = dt.clinicGroupProfit,
                            b = dt.clinicParentProfit;
                        ...
                        node.select('text')
                            ...
                            .text(function (d) {
                                ...
                                var str = '<img src="' + d.attributes.headPicFileName + '"/><div><b>姓名：</b>' + d.name +
                                    ...
                                    '<table style="text-align: center"><thead><tr><th></th><th>&nbsp;&nbsp;在线门诊&nbsp;&nbsp;</th><th>&nbsp;&nbsp;图文咨询&nbsp;&nbsp;</th><th>&nbsp;&nbsp;电话咨询&nbsp;&nbsp;</th><th>&nbsp;&nbsp;健康关怀&nbsp;&nbsp;</th></tr></thead>'+
                                    '<tbody><tr><td><b>集团&nbsp;&nbsp;</b></td><td>'+(_a?_a+' %':'0')+'</td><td>'+(_c?_c+' %':'0')+'</td><td>'+(_e?_e+' %':'0')+'</td><td>'+(_g?_g+' %':'0')+'</td></tr>'+
                                    '<tr><td><b>上级&nbsp;&nbsp;</b></td><td>'+(_b?_b+' %':'0')+'</td><td>'+(_d?_d+' %':'0')+'</td><td>'+(_f?_f+' %':'0')+'</td><td>'+(_h?_h+' %':'0')+'</td></tr></tbody></table>' +
                                    '</div>';
                                tips.html(str);
