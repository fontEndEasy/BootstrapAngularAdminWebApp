'use strict';
app.controller('CarePlanCtrl', function($scope, $http, toaster, $modal, $stateParams, EditCareInfoFtory, AddCareRemindFtory, AddMedicationFtory, AddCareCheckRemindFtory, AddLifeQualityFtory, AddSurveyFtory, AddCheckDocReplyFtory, AddIllnessTrackFtory) {
