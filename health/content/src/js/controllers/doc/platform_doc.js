 ...
 */
'use strict'
app.controller('PlatCtrl', function($scope, $timeout,utils,$http,modal,toaster,$location,$state) {
    var userId=localStorage.getItem('doc_user_id');
            ...
            platArticleTable = $('#doc_list').DataTable({
                ...
                "createdRow": function (nRow, aData, iDataIndex) {
                    ...
                    $(nRow).on('click','', function (event) {
                        ...
                        var url = $state.href('doc.article', {id: aData.id,createType:5});
