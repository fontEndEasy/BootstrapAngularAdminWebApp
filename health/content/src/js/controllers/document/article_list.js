 ...
 */
app.controller('ArticleCtrl', function($scope, $timeout,utils,$http,$modal,toaster,$location,$state) {
    'use strict'
    //当前集团id
    var curGroupId=localStorage.getItem('curGroupId');
    var userId;
    var logFromCompany=localStorage.getItem('logFromCompany');
    if(logFromCompany=='true'){
...
app.controller('docModalInstanceCtrl', function ($scope, $modalInstance,toaster,$http,utils) {
    //当前集团id
    var curGroupId=localStorage.getItem('curGroupId');
