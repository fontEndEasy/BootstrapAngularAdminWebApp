    ...
    return {
        ...
        link: function($scope, element, attr) {
            ...
            $scope.findDrugByKeyWord = function() {
                ...
                if (key == "") return;
                var query_for_drug_company_url = medicineApiRoot + "web/api/invoke/" + app.url.access_token + "/c_Goods.select";
                var set_good_state_url = medicineApiRoot + "web/api/invoke/" + app.url.access_token + "/c_GoodsOnStack.set_good_state";
                var url = '';
