'use strict';
app.controller('ChainIntegrationActive', function($rootScope, $scope, $state, $http, $compile, utils, modal) {
    var datable;
    //获取表格
    function setTable() {
        var data = {};
        ...
        function dataTable(data) {
            ...
            datable = $('#chainactive-table').dataTable({
                    ...
                    $(nRow).on('click', 'button', function() {
                        ...
                        if (!is_join_goods) { //未参加
                            if (!is_own_goods) {
                                ...
                                window.wxc.xcConfirm(text, window.wxc.xcConfirm.typeEnum.confirm, {
                                    okText: "去上架",
                                    cancelText: "知道了",
                                    onOk: function() {
            ...
            $("#chainactive-table input[name='checkall']").click(function() {
