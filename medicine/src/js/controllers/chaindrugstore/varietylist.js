...
app.controller('ChainVarietylist', function($rootScope, $scope, $state, $stateParams, $http, $compile, utils, modal) {
    ...
    $scope.submitCheck = function() {
        var ids = [];
        $("#chaincontactsList tbody tr input[type='checkbox']").each(function() {
    ...
    function setTable() {
        ...
        if (typeof $scope.title != 'undefined' && $scope.title.length > 0) {
            data['goods$trade_name'] = '%' + $scope.title + '%';
        }
        ...
        function dataTable(data) {
            ...
            datable = $('#chaincontactsList').dataTable({
                ...
                "createdRow": function(nRow, aData, iDataIndex) {
                    $(nRow).on('click', 'td', function() {
                        ...
                        $state.go('app.chainvarietylist.drug_detail', {
                            id: aData.goods.id,
                            state: typeof aData.cert_state != "undefined" ? aData.cert_state.value : 0
                        });
                    });
            ...
            var doctorList = $("#chaincontactsList");
