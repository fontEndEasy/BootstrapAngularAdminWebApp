'use strict';
app.controller('ChainDrugDetail', function ($rootScope, $scope, $state,$stateParams, $http, $compile, utils, modal,$sce) {
$scope.lists =[];
    //模态框退出
    $scope.cancel = function () {
        $('html').css("overflow","auto");
        $state.go('app.chainvarietylist',{},{'reload':false});
    };

    var id  = $stateParams.id;
    var cert_state  = $stateParams.state;//认证状态
    console.log("cert_state is:"+cert_state);
