'use strict';
app.controller('ChainContacts', function ($rootScope, $scope, $state, $http, $compile, utils, modal) {
    $scope.loading = true;
    $rootScope.loaded = true;
    $rootScope.$on('lister_chaindrugstore_list', function (evet, data) {
        initQuery();
    });
    ...
    $scope.addMonomerDrug = function () {
        $state.go('app.chaindrugstore.adds');
    };
