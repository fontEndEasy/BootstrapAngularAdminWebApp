'use strict';
app.controller('MonoIntegrationTable', function ($rootScope, $scope, $state, $http, $compile, utils, modal) {
   ...
   $scope.JF_goods_xh_list = [];
    ...
    function initStartDate(){
        $('#monointegrationtable_stime').daterangepicker({
        ...
        function(start, end, label) {
            ...
            $scope.end_date = "";
            $('#monointegrationtable_etime').val("");
    ...
    function initEndDate(_minDate){
        if(typeof _minDate != "undefined"){
            $('#monointegrationtable_etime').daterangepicker({
                singleDatePicker: true,
                minDate: _minDate,
                format:"YYYY-MM"
            },
