...
angular.module('app')
     ...
     */
    .constant('JQ_CONFIG', {
        baidumap: ['bower_components/baidumap/baidumap.js', 'bower_components/baidumap/baiduapi.js'],
        invoke: ['bower_components/invoke/invoke.js'],
        alert_confirm: ['bower_components/alert_confirm/xcConfirm.js', 'bower_components/alert_confirm/jquery-1.9.1.js', 'bower_components/alert_confirm/css/xcConfirm.css', 'bower_components/bootstrap-datetimepicker-master/sample in bootstrap v3/bootstrap/js/bootstrap.min.js'],
        ...
        dataTable: ['bower_components/datatables/media/js/jquery.dataTables.js', 'bower_components/plugins/integration/bootstrap/3/dataTables.bootstrap.js', 'bower_components/plugins/integration/bootstrap/3/dataTables.bootstrap.css'],
        ...
        jscharts: ['bower_components/javascript-charts/amcharts.js', 'bower_components/javascript-charts/serial.js'],
        umeditor: ['bower_components/umeditor/umeditor.config.js', 'bower_components/umeditor/umeditor.js', 'bower_components/umeditor/lang/zh-cn/zh-cn.js', 'bower_components/umeditor/themes/default/css/umeditor.min.css']
    })
    // oclazyload config
    .config(['$ocLazyLoadProvider',
        function($ocLazyLoadProvider) {
            ...
            $ocLazyLoadProvider.config({
                ...
                modules: [{
                    name: 'ui.bootstrap',
                    files: ['bower_components/angular-ui-bootstrap/ui-bootstrap-tpls-0.14.2.min.js']
                }, {
                    name: 'ngGrid',
